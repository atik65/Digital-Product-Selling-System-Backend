...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_lotteries_is_deleted'), 'lotteries', ['is_deleted'], unique=False)
    ...
    op.create_index(op.f('ix_site_settings_is_deleted'), 'site_settings', ['is_deleted'], unique=False)
    ...
    op.create_index(op.f('ix_topups_is_deleted'), 'topups', ['is_deleted'], unique=False)
    op.create_index(op.f('ix_topups_payment_method_id'), 'topups', ['payment_method_id'], unique=False)
    op.create_index(op.f('ix_topups_status'), 'topups', ['status'], unique=False)
    op.create_index(op.f('ix_topups_transaction_id'), 'topups', ['transaction_id'], unique=False)
    ...
    op.create_index(op.f('ix_packages_product_id'), 'packages', ['product_id'], unique=False)
    ...
    op.create_table('product_input_fields',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('product_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_product_input_fields_id'), 'product_input_fields', ['id'], unique=False)
    op.create_index(op.f('ix_product_input_fields_is_deleted'), 'product_input_fields', ['is_deleted'], unique=False)
    op.create_index(op.f('ix_product_input_fields_product_id'), 'product_input_fields', ['product_id'], unique=False)
    ...
    op.create_table('lottery_prizes',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_lottery_prizes_id'), 'lottery_prizes', ['id'], unique=False)
    op.create_index(op.f('ix_lottery_prizes_is_deleted'), 'lottery_prizes', ['is_deleted'], unique=False)
    op.create_index(op.f('ix_lottery_prizes_lottery_id'), 'lottery_prizes', ['lottery_id'], unique=False)
    ...
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['lottery_id'], ['lotteries.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['lottery_prize_id'], ['lottery_prizes.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_lottery_entries_id'), 'lottery_entries', ['id'], unique=False)
    op.create_index(op.f('ix_lottery_entries_is_deleted'), 'lottery_entries', ['is_deleted'], unique=False)
    op.create_index(op.f('ix_lottery_entries_lottery_id'), 'lottery_entries', ['lottery_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.add_column('products', sa.Column('price', sa.DOUBLE_PRECISION(precision=53), server_default=sa.text("'0'::double precision"), autoincrement=False, nullable=False))
    ...
    op.drop_index(op.f('ix_product_input_fields_product_id'), table_name='product_input_fields')
    op.drop_index(op.f('ix_product_input_fields_is_deleted'), table_name='product_input_fields')
