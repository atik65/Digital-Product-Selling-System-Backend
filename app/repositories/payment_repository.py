...
class PaymentRepository:
    def create(self, db: Session, data: dict) -> Payment:
        ...
        try:
            ...
            raise DatabaseException(
                f"Failed to submit payment: {str(e)}", original_exception=e
            )
    ...
    def get_all(
        ...
        try:
            ...
            raise DatabaseException(
                f"Failed to fetch payments: {str(e)}", original_exception=e
            )
    ...
    def update_verification(
        ...
        try:
            ...
            db.rollback()
            raise DatabaseException(
                f"Failed to update payment status: {str(e)}", original_exception=e
            )
